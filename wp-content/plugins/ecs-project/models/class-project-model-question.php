...
class Project_Model_Question
{
  ...
  function __construct($template_parser)
  {
    ...
    $this->post_type_name = 'question';
    $this->post_type_singular = __('Pregunta frecuente', 'enigmind');
    $this->post_type_plural = __('Preguntas frecuente', 'enigmind');
    $this->menu_icon = 'dashicons-editor-help';
